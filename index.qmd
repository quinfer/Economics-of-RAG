...
- First major project for [Finance and AI Research lab (FAIR)](https://q-rap.connect.qub.ac.uk/FAIR/) established in 2023.
...
## Work Package 1: Use Case Definition, Data Collection & Process Mapping {.smaller}
...
## Client Engagement Opportunities {.smaller}
...
- Use the MIMUS tool to detect inconsistencies in rule sets.
...
## Theoretical Framework in Economics {.smaller}
...
![Hybrid Economic Analysis Framework](imgs/mermaid-diagram-2024-11-19-113920.png)
